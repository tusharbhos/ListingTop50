    ...
    return (
      <div className="text-center py-12">
        ...
        <div className="mt-6 space-y-2">
          ...
          <p className="text-lg text-[var(--primary-color)] animate-pulse">
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-gray-800 mb-6">
        Where to contact you<span className="text-orange-500">?</span>
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-between pt-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition disabled:opacity-50 flex items-center gap-2"
          >
            {loading ? (
              <>
